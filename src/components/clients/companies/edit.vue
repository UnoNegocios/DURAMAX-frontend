    ...
    <v-card>
        <v-card-title class="pb-0 pt-1" >
            ...
            <v-col cols="12" sm="6" md="4">
                ...
                <v-autocomplete v-else disabled v-model="company.user_id" :items="usersLists" label="Responsable" item-text="name" item-value="id">                
                </v-autocomplete>
            </v-col>
        </v-card-title>
        <v-divider></v-divider>
                ...
                <v-col cols="12" sm="6" md="8">
                    <v-row>
                        <v-col cols="12" class="pb-0" sm="6" md="6">
                            <v-text-field prepend-inner-icon="mdi-account" :rules="[v => !!v || 'Campo requerido']" v-model="company.name" label="Nombre"></v-text-field>
                        </v-col>
                        <v-col cols="12" class="pb-0" sm="6" md="6">
...
import axios from "axios";
    ...
    methods: {
        ...
        save () {
            ...
            axios.put("https://backendduramax.unocrm.mx/api/v1/company/update",Object.assign(this.company)).then(response=>{
                this.gris = false
                this.close()
            })
