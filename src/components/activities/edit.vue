    ...
    export default {
        ...
        methods: {
            ...
            save(){
                ...
                axios.put("https://backendduramax.unocrm.mx/api/v1/calendar/update",Object.assign(this.calendar)).then(response=>{
                    this.gris = false
                    this.close()
                })
            },
