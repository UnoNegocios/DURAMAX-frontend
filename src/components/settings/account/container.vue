            ...
            <div style="background:white;" class="px-6 pb-5">
                ...
                <v-row class="pt-4">
                    ...
                    <v-col cols="7">
                        ...
                        <v-text-field v-else v-model="currentUser.name"  @click:append="save" :disabled="gris" :loading="gris" append-icon="mdi-content-save" label="Nombre" placeholder="Nombre" outlined></v-text-field>
                    </v-col>
                ...
                <v-row class="pt-4">
                    ...
                    <v-col cols="7">
                        ...
                        <v-text-field v-model="currentUser.email" @click:append="save" :disabled="gris" :loading="gris" append-icon="mdi-content-save" v-else label="Correo Electrónico" placeholder="Correo Electrónico" outlined></v-text-field>
                    </v-col>
                    <v-col cols="2" class="pl-7">
                ...
                <v-row class="pt-4">
                    ...
                    <v-col cols="7">
                        ...
                        <v-text-field v-model="editedPassword.password" @click:append="savePassword" :disabled="gris" :loading="gris" append-icon="mdi-content-save" v-else label="Contraseña" placeholder="Contraseña" outlined></v-text-field>
                    </v-col>
                    <v-col cols="2" class="pl-7">
                ...
                <v-row class="pt-4">
                    ...
                    <v-col cols="7">
                        ...
                        <v-text-field v-model="currentUser.phone" @click:append="save" :disabled="gris" :loading="gris" append-icon="mdi-content-save" v-else label="Teléfono" placeholder="Teléfono" outlined></v-text-field>
                    </v-col>
                    <v-col cols="2" class="pl-7">
...
<script>
    ...
    export default {
        ...
        methods:{
            save(){
                this.gris = true
                axios.put("https://backendduramax.unocrm.mx/api/v1/user/update",Object.assign(this.currentUser)).then(response=>{
            ...
            savePassword(){
                this.gris = true
                axios.put("https://backendduramax.unocrm.mx/api/v1/user/password",Object.assign(this.currentUser, this.editedPassword)).then(response=>{
                    this.editedPassword=''
