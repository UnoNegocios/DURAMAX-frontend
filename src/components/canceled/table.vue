...
export default {
    ...
    computed: {
        ...
        quotationsLists(){
            var quotations = this.$store.state.quotation.quotations.filter(quotation=>quotation.status == 'cancelado')
    ...
    methods: {
        ...
        status(){
            var editedItem = this.$store.state.quotation.quotations.filter(quotation=>quotation.id == this.statusId)[0]
        ...
        filtersQuotation: function(params) {
            if(this.company!='' && this.company!=undefined && this.company!=null){
                var filterQuotation = this.$store.state.quotation.quotations.filter(quotation=>quotation.status == 'cancelado').filter(quotation=>quotation.company_id == this.company)
            }else{
                var filterQuotation = this.$store.state.quotation.quotations.filter(quotation=>quotation.status == 'cancelado')
            }
